...
// Ativar links
const _links = document.querySelectorAll(".list-unstyled a");
...
inputHorario.addEventListener("change", function () {
    ...
    fetch(
        "/taxa-aluguel/" + horarioSelecionado + "?bicicleta_id=" + bicicleta_id
    )
        .then((response) => {
            if (!response.ok) {
...
document
    .getElementById("tipoPagamentoPlano")
...
// Ativar links perfil
// const linksUser = document.querySelectorAll(".list-unstyled a");

// function ativarLink(linksUser) {
//     const url = location.href;
//     const href = link.href;
//     if (url.includes(href)) {
//         linksUser.classList.add("ativo");
//     }
// }

// linksUser.forEach(ativarLink);
